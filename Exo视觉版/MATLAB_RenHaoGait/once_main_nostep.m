...
[state,a_hl_f,a_hr_f,a_kl_f,a_kr_f]=gait_finish(gait_length_change_small,gait_height_finish,gait_length_normal,gait_length_change_small);%finish的最后一个输入参数要和上一个函数的输入步长一致
