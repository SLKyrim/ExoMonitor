    ...
    class WriteExcel
    {
        ...
        public bool writeStart(StatusBar statusBarIn, TextBlock statusInfoTextBlockIn, Motors motorsIn)
        {
            ...
            try
            {
                ...
                ExcelWorksheet.Cells[2, 1] = "电机电流(A)";
                ...
                ExcelWorksheet.Cells[2, PARA_NUM + 1] = "电机电流(A)";
                ...
                ExcelWorksheet.Cells[2, 2 * PARA_NUM + 1] = "电机电流(A)";
                ...
                ExcelWorksheet.Cells[2, 3 * PARA_NUM + 1] = "电机电流(A)";
        ...
        public bool writeStop()
        {
            try
            {
                ...
                {
                    ExcelWorkbook.SaveAs(@"C:\Users\zhineng\Desktop\电流.xlsx"); //默认保存路径为C:\Users\Administrator\Documents
        ...
        {
            ExcelWorksheet.Cells[excelCnt, 1] = (motors.ampObj[0].CurrentActual) * 0.01;
            ExcelWorksheet.Range[ExcelWorksheet.Cells[excelCnt, 1], ExcelWorksheet.Cells[excelCnt, PARA_NUM]].Interior.ColorIndex = 39;

            ExcelWorksheet.Cells[excelCnt, PARA_NUM + 1] = (motors.ampObj[1].CurrentActual) * 0.01;
            ...
            ExcelWorksheet.Cells[excelCnt, 2 * PARA_NUM + 1] = (motors.ampObj[2].CurrentActual) * 0.01;
            ...
            ExcelWorksheet.Cells[excelCnt, 3 * PARA_NUM + 1] = (motors.ampObj[3].CurrentActual) * 0.01;
